function [Stims,stim_list,masker_list, call_subjects_list] = make_wav_files_SM(Outfiles,Stims,...
                                                        songfilt_args)
...
stim_list = write_wav_file_SM(Outfiles.stimwav,stim_list,stim_prefix,...
                           songfilt_args);

[outdir,mask_prefix,wavext] = fileparts(Outfiles.maskwav);
masker_list = write_wav_file_SM(Outfiles.maskwav,masker_list,mask_prefix,...
                             songfilt_args);
